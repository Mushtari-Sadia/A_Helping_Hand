...
# TODO 1 : CREATE ALL TABLES FOLLOWING OUR SCHEMA
...
connection.cursor().execute("CREATE TABLE Appliances(appliances_id NUMBER GENERATED BY DEFAULT AS IDENTITY," +
         "type VARCHAR2(20)," +
         "PRIMARY KEY(appliances_id));")


connection.cursor().execute("CREATE TABLE Area_Of_Expertise(electrician_id NUMBER," +
         "appliances_id NUMBER,"+
		 "FOREIGN KEY(appliances_id) REFERENCES Appliances(appliances_id),"+
		 "PRIMARY KEY(electrician_id,appliances_id));")
